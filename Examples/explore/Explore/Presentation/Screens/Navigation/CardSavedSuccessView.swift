...
/// Debug-friendly success screen that displays saved-card metadata returned by Elements widgets.
public struct CardSavedSuccessView: View {
    ...
    public var body: some View {
        VStack(spacing: 20) {
            ...
            Text(
                "Expiration Date: \(savedCardData["expiration_date"] ?? savedCardData["expirationDate"] ?? "")"
            )
