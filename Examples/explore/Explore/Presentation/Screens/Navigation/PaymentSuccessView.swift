...
/// UI model used to render a single order item returned in payment success payloads.
struct OrderItem: Identifiable {
    ...
    init?(dictionary: [String: Any]) {
        guard let id = dictionary["id"] as? String,
            ...
            let totalAmount = totalAmountDict["display_amount"] as? String
        else {
            return nil
        }
...
/// Debug-friendly success screen that displays order data returned by payment-like widgets.
