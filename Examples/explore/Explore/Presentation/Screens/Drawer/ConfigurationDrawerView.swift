            ...
            ScrollViewReader { proxy in
                ScrollView(showsIndicators: false) {
                    VStack(alignment: .leading, spacing: ExploreSpacing.sectionSpacing) {
                        ...
                        UserInfoSection(
                            firstName: $draftConfig.userInfoFirstName,
                            lastName: $draftConfig.userInfoLastName,
                            email: $draftConfig.userInfoEmail
                        )
                ...
                .accessibilityIdentifier("sdktester.drawer.scrollView")
