...
public enum WebViewUserContentControllerNames {
    public static let remoteJs = "remoteJs"
    ...
    public static let contentResize = "contentResize"
}
...
public enum QueryParameters {
    ...
    static let showSavedCardFlow = "showSavedCardFlow"
    static let defaultCardFlow = "defaultCardFlow"
    static let manualSubmit = "manualSubmit"
    static let int = "int"
