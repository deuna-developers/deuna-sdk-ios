...
public struct CheckoutEventResponse: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.type = CheckoutEventType(rawValue: typeString) ?? .custom // Failsafe here

        self.data = try container.decode(CheckoutEventResponseData.self, forKey: .data)
    }
...
public enum CheckoutEventType: String, Codable {
    ...
    case paymentMethodsShowMyCards = "paymentMethodsShowMyCards"
    case benefitsStarted = "benefitsStarted"
    case donationsStarted = "donationsStarted"
    case donationsUsed = "donationsUsed"
}
