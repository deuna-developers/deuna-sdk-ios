...
class NewTabWebViewController: BaseWebViewController, DeunaWebViewDelegate, WKScriptMessageHandler {
    ...
    private func loadUrl() {
        ...
        controller.webView = WKWebView(frame: view.bounds, configuration: configuration)
        view.addSubview(controller.webView!)
        controller.deunaDelegate = self
    ...
    func close(mainViewWasClosed: Bool = false) {
        self.mainViewWasClosed = mainViewWasClosed
